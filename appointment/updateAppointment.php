        ...
        <div class="main">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($julianEndTime > $julianStartTime) {
                    ...
                    $statement = $db->prepare("UPDATE Appointment SET start_time = :startTime, end_time = :endTime, reason = :reason, PatientID = :patientID, StaffID = :staffID
                    ...
                    if ($statement->execute()) {
                        echo "<h1>Appointment was successfully updated.</h1>";
                    } else {
                        echo "<h1>Failed to update Appointment.</h1>";
                    }
                } else {
                    echo "<h1>Failed to update Appointment.</h1>";
