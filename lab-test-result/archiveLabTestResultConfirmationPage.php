  ...
  <div class="main-container">
    ...
    <div class="main">
      <?php 
        ...
        $statement = $db->prepare("SELECT ltt.name, p.first_name || ' ' || coalesce(p.middle_name || '', '') || ' ' || p.last_name AS 'Patient Name' 
        ...
        $labTestName = $record['name'];
        $patientName = $record['Patient Name'];
        $db->close();
      ?>
      <h1>Are you sure that you want to archive <?php echo $patientName; ?>'s <?php echo $labTestName; ?> result from the Lab Test Result table?</h1>
      <h2>Archiving a record is permanent, and can't be reversed.</h2>
      <a href="archiveLabTestResult.php?LabTestResultID=<?php echo $labTestResultID; ?>"><button class="delete-btn" style="width: 15%">Yes, archive the lab test result</button></a>
