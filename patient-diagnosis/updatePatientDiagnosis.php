    ...
    <div class="main-container">
        ...
        <div class="main">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $patientDiagnosisID = $_POST['PatientDiagnosisID'];
                ...
                $statement = $db->prepare("UPDATE PatientDiagnosis SET PatientID = :patientID, DiagnosisTypeID = :diagnosisTypeID, 
                                    diagnosis_date = :dateOfDiagnosis, description = :description WHERE PatientDiagnosisID = :patientDiagnosisID");
                ...
                if ($statement->execute()) {
                    echo "<h1>Patient Diagnosis was successfully updated.</h1>";
                } else {
                    echo "<h1>Failed to update Patient Diagnosis.</h1>";
                }
