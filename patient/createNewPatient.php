  ...
  <div class="main-container">
    ...
    <div class="main">
      ...
      if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $statement = $db->prepare("INSERT INTO Patient(first_name, middle_name, last_name, contact_number, date_of_birth, address_line1, address_line2, city, postcode, country)
                                      VALUES(:FirstName, :MiddleName, :LastName, :ContactNumber, :DateOfBirth, :AddressLine1, :AddressLine2, :City, :Postcode, :Country);");
        ...
        if ($statement->execute()) {
          echo "<h1>Patient was successfully created.</h1>";
        } else {
          echo "<h1>Failed to create Patient.<h1>";
        }
