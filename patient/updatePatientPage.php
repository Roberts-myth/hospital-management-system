...
<body onload="loadNavbar()">
    <div class="main-container">
        ...
        <div class="main">
            ...
            $statement = $db->prepare("SELECT * FROM Patient WHERE PatientID = :patientID;");
            ...
            <form action="updatePatient.php" method="post">
                ...
                <input type="number" id="PatientID" name="PatientID" value="<?php echo $patientID; ?>" readonly>
                ...
                <input type="date" id="date-of-birth" name="date-of-birth" value="<?php echo $dateOfBirth; ?>" required>                
                ...
                <small><br>The Patient's current country is <?php echo $country; ?></small>
